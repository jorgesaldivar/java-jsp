...
{    
        ...
        throws ServletException, IOException
    {
        ...
        User user = new User(firstName, lastName, emailAddress,career);
        sc.setAttribute("user", user);
        if (firstName.equals("") || lastName.equals("") || emailAddress.equals("")){
             String message = "Please fill missing fields";
             sc.setAttribute("message", message);
             sc.getRequestDispatcher("/join_email_list.jsp").forward(request, response);
        ...
        if (valido) {
            ...
            sc.getRequestDispatcher("/display_email_list.jsp").forward(request, response);
