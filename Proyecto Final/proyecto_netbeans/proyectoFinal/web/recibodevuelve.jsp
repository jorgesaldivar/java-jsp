<%-- 
    Document   : recibodevuelve
    Created on : 26-jun-2012, 17:20:03
    Author     : joab
--%>
  ...
  <jsp:include page="includes/header.jsp" />
      <%Cliente nuevo=(Cliente)request.getAttribute("cliente");
        %>
          ...
          <h1 style="text-align: center;" >Return to</h1>
...
%>
            ...
            <form id="form" action="EnviarDevueltos">
                <%request.getSession().setAttribute("recibo", lista);%>
